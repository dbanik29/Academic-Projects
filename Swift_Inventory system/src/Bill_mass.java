...
public class Bill_mass extends JFrame {
	...
	JLabel cancel = new JLabel("");
	    ...
	    static Bill_mass frame = new Bill_mass();
		...
		edit.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				...
				frame.dispose();
					...
					Bill_create.title.setText("Bill Edit");
					Bill_create.setVisible(true);
					Bill_create.show(order_no,suppliers,date,bill_no,amount);
			}
			@Override
		...
		delete.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				...
				frame.dispose(); //Destroy the JFrame object
					...
					Message_status.class_name="Bill_D";
					Message_status.order_no=order_no;
					Message_status.suppliers=suppliers;
			}
			@Override
			public void mousePressed(MouseEvent e) {
				delete.setIcon(new ImageIcon(Dashboard.class.getResource("/img/delete2.png")));

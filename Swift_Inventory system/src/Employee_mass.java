...
public class Employee_mass extends JFrame {
	...
	JLabel cancel = new JLabel("");
	    ...
	    static Employee_mass frame = new Employee_mass();
	...
	public Employee_mass() {
		...
		edit.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				...
				Employee_info.show(company, employee);
				Employee_info.edit.setText("Edit Employee Info");
		...
		delete.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				...
				frame.dispose(); //Destroy the JFrame object
					...
					Message_status.class_name="Employee_D";
					Message_status.company=company;
					Message_status.employee=employee;

...
public class COD_sales extends JFrame {
	...
	JLabel employee = new JLabel("");
	   ...
	   JLabel search = new JLabel("");
	    ...
	    static COD_sales frame = new COD_sales();
	...
	private final JLabel label = new JLabel("Invoice No.");
	private final JLabel label_1 = new JLabel("Invoice Date");
	private final JLabel label_2 = new JLabel("Order No.");
	private final JLabel label_3 = new JLabel("Sales Status");
	private final JLabel label_4 = new JLabel("Amount");
	private final JLabel label_5 = new JLabel("Customer ID");
	private final JLabel label_6 = new JLabel("Employee ID");
	private final JTable table1 = new JTable();
	private final JScrollPane scrollPane1 = new JScrollPane();
	private final JLabel supplier = new JLabel("");
	private final JLabel lblUnpaidCod = new JLabel("Unpaid COD");
	private final JLabel lblPaidCod = new JLabel("Paid COD");
	
    public void refresh_table(){
    	try{
			String q1="(SELECT orders.Date,   order_status.Invoice_no, order_status.Order_id, order_status.Sales_Status,Sum(Unit_price*Quantity) as Ampunt, orders.Customer_id, order_status.Employee_id "; 
			String q2=" FROM orders, order_status WHERE orders.Order_id=order_status.Order_id and order_status.Status='Ordered'  and order_status.Sales_Status='COD' GROUP by order_status.Order_id)"; 
			
			PreparedStatement pst=connection.prepareStatement(q1+q2);
		...
		try{
			String q1="(SELECT orders.Date,   order_status.Invoice_no, order_status.Order_id, order_status.Sales_Status,Sum(Unit_price*Quantity) as Ampunt, orders.Customer_id, order_status.Employee_id "; 
			String q2=" FROM orders, order_status WHERE orders.Order_id=order_status.Order_id and order_status.Status='Ordered'  and order_status.Sales_Status='COD P' GROUP by order_status.Order_id)"; 
    ...
    public void refresh(){
		try{
			String q1="(SELECT orders.Date,  order_status.Invoice_no,order_status.Order_id, order_status.Sales_Status,  Sum(Unit_price*Quantity) as Ampunt,  orders.Customer_id, order_status.Employee_id "; 
			String q2=" FROM orders, order_status WHERE orders.Order_id=order_status.Order_id and order_status.Status='Ordered'  and (order_status.Sales_Status='COD' or order_status.Sales_Status='COD P') "; 
			String q3=" and ( orders.Date LIKE '%" + Search.getText() + "%' or order_status.Invoice_no LIKE '%" + Search.getText() + "%' or order_status.Order_id LIKE '%" + Search.getText() + "%' or order_status.Employee_id LIKE '%" + Search.getText() + "%' or orders.Customer_id LIKE '%" + Search.getText() + "%' or order_status.Sales_Status LIKE '%" + Search.getText() + "%') GROUP by order_status.Order_id)";
	...
	public COD_sales() {
		...
		JLabel title = new JLabel("COD Sales");
		...
		refreshes.setIcon(new ImageIcon(COD_sales.class.getResource("/img/refresh.png")));
		...
		contentPane.add(Search);
		scrollPane.setBounds(218, 176, 1060, 193);
		...
		table.setCellSelectionEnabled(true);
		Border emptyBorder1 = BorderFactory.createEmptyBorder(0, 0, 0, 0);
		try{
			String q1="(SELECT orders.Date,   order_status.Invoice_no, order_status.Order_id, order_status.Sales_Status,Sum(Unit_price*Quantity) as Ampunt, orders.Customer_id, order_status.Employee_id "; 
			String q2=" FROM orders, order_status WHERE orders.Order_id=order_status.Order_id and order_status.Status='Ordered'  and order_status.Sales_Status='COD' GROUP by order_status.Order_id)"; 
		...
		label.setFont(new Font("Futura Lt BT", Font.BOLD, 14));
		label.setBounds(405, 149, 112, 14);
		
		contentPane.add(label);
		label_1.setFont(new Font("Futura Lt BT", Font.BOLD, 14));
		label_1.setBounds(250, 149, 107, 14);
		
		contentPane.add(label_1);
		label_2.setFont(new Font("Futura Lt BT", Font.BOLD, 14));
		label_2.setBounds(545, 149, 90, 14);
		
		contentPane.add(label_2);
		label_3.setFont(new Font("Futura Lt BT", Font.BOLD, 14));
		label_3.setBounds(719, 149, 100, 14);
		
		contentPane.add(label_3);
		label_4.setFont(new Font("Futura Lt BT", Font.BOLD, 14));
		label_4.setBounds(870, 149, 100, 14);
		
		contentPane.add(label_4);
		label_5.setFont(new Font("Futura Lt BT", Font.BOLD, 14));
		label_5.setBounds(1026, 149, 96, 14);
		
		contentPane.add(label_5);
		label_6.setFont(new Font("Futura Lt BT", Font.BOLD, 14));
		label_6.setBounds(1150, 149, 96, 14);
		
		contentPane.add(label_6);
		scrollPane1.setBounds(218, 430, 1060, 277);
		...
		table1.setFont(new Font("Eras Medium ITC", Font.PLAIN, 13));
		
		table1.setBackground(new Color(230, 250, 255));
		
		table1.getTableHeader().setUI(null);
		
		scrollPane1.setViewportView(table1);
		scrollPane1.setBackground(new Color(230, 250, 255));
		scrollPane1.setViewportBorder(null);
		
		
		table.setCellSelectionEnabled(true);
		Border emptyBorder11 = BorderFactory.createEmptyBorder(0, 0, 0, 0);
		
		scrollPane1.setBorder(emptyBorder11);
		supplier.setIcon(new ImageIcon(COD_sales.class.getResource("/img/supplier1.png")));
		supplier.setBounds(0, 707, 200, 40);
		
		contentPane.add(supplier);
		lblUnpaidCod.setForeground(new Color(0, 0, 51));
		lblUnpaidCod.setFont(new Font("Futura Lt BT", Font.BOLD, 20));
		lblUnpaidCod.setBounds(218, 118, 145, 20);
		
		contentPane.add(lblUnpaidCod);
		lblPaidCod.setForeground(new Color(0, 0, 51));
		lblPaidCod.setFont(new Font("Futura Lt BT", Font.BOLD, 20));
		lblPaidCod.setBounds(218, 392, 145, 20);
		
		contentPane.add(lblPaidCod);
		table.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				String value3 = table.getModel().getValueAt(row, 5).toString();
				
				System.out.println(row+"  "+co+"  "+value+" "+value1+" "+" "+value3);
				
				COD_payment COD_payment= new COD_payment();
				COD_payment.user_id.setText(user_id.getText());
				COD_payment.setVisible(true);
				COD_payment.user_id.setText(user_id.getText());
				COD_payment.Invoice=value;
				COD_payment.Total=value1;
				COD_payment.Customer_id=value3;
				COD_payment.Message.setText("Are you sure?");

...
public class Bill_edit extends JFrame {
	...
	JLabel supplier = new JLabel("");
	   ...
	   JLabel search = new JLabel("");
	    ...
	    static Bill_edit frame = new Bill_edit();
	...
	private final JLabel add_supplier = new JLabel("");
	private final JLabel add_bill = new JLabel("");
	private final JLabel lblSupplierOrderNo = new JLabel("Supplier Order No.");
	private final JLabel lblSupplierId = new JLabel("Supplier ID");
	private final JLabel lblDate = new JLabel("Date");
	private final JLabel lblBillNo = new JLabel("Bill No.");
	private final JLabel lblAmount = new JLabel("Amount");
	private final JLabel label_5 = new JLabel("Status");
	
	public void refresh(){
		try{
			String q1="SELECT * FROM supplier_order";
			String q2=" WHERE S_Order_id LIKE '%" + Search.getText() + "%' or Date LIKE '%" + Search.getText() + "%' or Supplier_id LIKE '%" + Search.getText() + "%' or Status LIKE '%" + Search.getText() + "%' or Bill_no LIKE '%" + Search.getText() + "%'  ";
		PreparedStatement pst10=connection.prepareStatement(q1+q2);
	...
	public void refresh_table(){
		try{
			...
			column.getColumn(1).setPreferredWidth(70);
	...
	public Bill_edit() {
		...
		contentPane.addMouseMotionListener(new MouseMotionAdapter() {
			@Override
			public void mouseMoved(MouseEvent arg0) {avater_drop.setIcon(new ImageIcon(Dashboard.class.getResource("/img/avater_drop1.1.png")));
		...
		refreshes.setIcon(new ImageIcon(Supplier.class.getResource("/img/refresh.png")));
		...
		add_supplier.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseEntered(MouseEvent e) {
				add_supplier.setIcon(new ImageIcon(Dashboard.class.getResource("/img/add_supplier2.png")));
			}
			@Override
			public void mouseExited(MouseEvent e) {
				add_supplier.setIcon(new ImageIcon(Dashboard.class.getResource("/img/add_supplier1.png")));
			}
			@Override
			public void mouseClicked(MouseEvent arg0) {
				add_supplier.setIcon(new ImageIcon(Dashboard.class.getResource("/img/add_supplier3.png")));
				Supplier_info Supplier_info= new Supplier_info();
				Supplier_info.user_id.setText(user_id.getText());
				Supplier_info.edit.setText("Add New Supplier");
		...
		add_bill.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseEntered(MouseEvent e) {
				add_bill.setIcon(new ImageIcon(Dashboard.class.getResource("/img/add_bill2.png")));
			}
			@Override
			public void mouseExited(MouseEvent e) {
				add_bill.setIcon(new ImageIcon(Dashboard.class.getResource("/img/add_bill1.png")));
			}
			@Override
			public void mouseClicked(MouseEvent arg0) {
				add_bill.setIcon(new ImageIcon(Dashboard.class.getResource("/img/add_bill3.png")));
				setVisible(false);
				frame.dispose();
		...
		table.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				String order_no = table.getModel().getValueAt(row, 0).toString();
				String suppliers = table.getModel().getValueAt(row, 1).toString();
				String date = table.getModel().getValueAt(row, 2).toString();
				String bill_no = table.getModel().getValueAt(row, 3).toString();
				String amount = table.getModel().getValueAt(row, 4).toString();
				System.out.println(row+"  "+co+"  "+order_no);

				
				Bill_mass Bill_mass= new Bill_mass();
				Bill_mass.user_id.setText(user_id.getText());
				Bill_mass.setVisible(true);
				Bill_mass.order_no=order_no;
				Bill_mass.suppliers=suppliers;
				Bill_mass.date=date;
				Bill_mass.bill_no=bill_no;
				Bill_mass.amount=amount;
				Bill_mass.Message.setText("Order No. "+order_no);
			}
		});
		...
		add_supplier.setIcon(new ImageIcon(Supplier.class.getResource("/img/add_supplier1.png")));
		add_supplier.setBounds(1130, 71, 150, 41);
		
		contentPane.add(add_supplier);
		add_bill.setIcon(new ImageIcon(Supplier.class.getResource("/img/add_bill1.png")));
		add_bill.setBounds(970, 71, 150, 41);
		
		contentPane.add(add_bill);
		user_id.setBounds(-2220, 71, 46, 14);
		contentPane.add(user_id);
		lblSupplierOrderNo.setFont(new Font("Futura Lt BT", Font.BOLD, 14));
		lblSupplierOrderNo.setBounds(245, 133, 142, 14);
		
		contentPane.add(lblSupplierOrderNo);
		lblSupplierId.setFont(new Font("Futura Lt BT", Font.BOLD, 14));
		lblSupplierId.setBounds(447, 133, 112, 14);
		
		contentPane.add(lblSupplierId);
		lblDate.setFont(new Font("Futura Lt BT", Font.BOLD, 14));
		lblDate.setBounds(640, 133, 90, 14);
		
		contentPane.add(lblDate);
		lblBillNo.setFont(new Font("Futura Lt BT", Font.BOLD, 14));
		lblBillNo.setBounds(807, 133, 100, 14);
		
		contentPane.add(lblBillNo);
		lblAmount.setFont(new Font("Futura Lt BT", Font.BOLD, 14));
		lblAmount.setBounds(980, 133, 100, 14);
		
		contentPane.add(lblAmount);
		label_5.setFont(new Font("Futura Lt BT", Font.BOLD, 14));
		label_5.setBounds(1161, 133, 96, 14);

...
public class Credit_sales extends JFrame {
	...
	JLabel employee = new JLabel("");
	   ...
	   JLabel search = new JLabel("");
	    ...
	    static Credit_sales frame = new Credit_sales();
	...
	private final JLabel label = new JLabel("Invoice Date");
	private final JLabel label_1 = new JLabel("Invoice No.");
	...
	public void refresh(){
		try{
			...
			String q2=" FROM orders, order_status WHERE orders.Order_id=order_status.Order_id and order_status.Status='Ordered'  and order_status.Sales_Status='Due' "; 
			String q3=" and (orders.Date LIKE '%" + Search.getText() + "%' or order_status.Invoice_no LIKE '%" + Search.getText() + "%' or order_status.Order_id LIKE '%" + Search.getText() + "%' or orders.Customer_id LIKE '%" + Search.getText() + "%' or order_status.Employee_id LIKE '%" + Search.getText() + "%') GROUP by order_status.Order_id)";
	...
	public Credit_sales() {
		...
		refreshes.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
					...
					try{
						String q1="(SELECT orders.Date, order_status.Invoice_no,  order_status.Order_id, order_status.Sales_Status, Sum(Unit_price*Quantity) as Ampunt, orders.Customer_id, order_status.Employee_id "; 
						String q2=" FROM orders, order_status WHERE orders.Order_id=order_status.Order_id and order_status.Status='Ordered'  and order_status.Sales_Status='Due' GROUP by order_status.Order_id)"; 
		...
		refreshes.setIcon(new ImageIcon(Credit_sales.class.getResource("/img/refresh.png")));
		...
		supplier.setIcon(new ImageIcon(Credit_sales.class.getResource("/img/supplier1.png")));

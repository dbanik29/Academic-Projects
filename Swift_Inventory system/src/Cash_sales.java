...
public class Cash_sales extends JFrame {
	...
	JLabel employee = new JLabel("");
	   ...
	   JLabel search = new JLabel("");
	    ...
	    static Cash_sales frame = new Cash_sales();
	...
	private final JLabel lblInvoiceDate = new JLabel("Invoice Date");
	private final JLabel lblInvoiceNo = new JLabel("Invoice No.");
	private final JLabel lblOrderNo = new JLabel("Order No.");
	private final JLabel lblSalesStatus = new JLabel("Sales Status");
	...
	public void refresh(){
		try{
			...
			String q2=" FROM orders, order_status WHERE orders.Order_id=order_status.Order_id and order_status.Status='Ordered'  and order_status.Sales_Status='cash' "; 
			String q3=" and ( orders.Date LIKE '%" + Search.getText() + "%' or order_status.Invoice_no LIKE '%" + Search.getText() + "%' or order_status.Order_id LIKE '%" + Search.getText() + "%' or order_status.Employee_id LIKE '%" + Search.getText() + "%' or orders.Customer_id LIKE '%" + Search.getText() + "%') GROUP by order_status.Order_id";
	...
	public void refresh_table(){
		try{
			String q1="(SELECT orders.Date,  order_status.Invoice_no,order_status.Order_id, order_status.Sales_Status,  Sum(Unit_price*Quantity) as Ampunt,  orders.Customer_id, order_status.Employee_id "; 
			String q2=" FROM orders, order_status WHERE orders.Order_id=order_status.Order_id and order_status.Status='Ordered'  and order_status.Sales_Status='cash' GROUP by order_status.Order_id)"; 
	...
	public Cash_sales() {
		...
		JLabel Cash_Sales = new JLabel("Cash Sales");
		Cash_Sales.setForeground(Color.WHITE);
		Cash_Sales.setFont(new Font("Futura Lt BT", Font.BOLD, 30));
		Cash_Sales.setBounds(270, 17, 191, 28);
		...
		refreshes.setIcon(new ImageIcon(Cash_sales.class.getResource("/img/refresh.png")));

...
public class Order_mass extends JFrame {
	...
	JLabel cancel = new JLabel("");
	    ...
	    static Order_mass frame = new Order_mass();
	...
	public Order_mass() {
		...
		setBounds(-100, -100, 220, 390);
		setShape(new RoundRectangle2D.Double(00, 00, 220, 390, 50, 50));
		...
		show.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				...
				Order_create Order_create= new Order_create();
				Order_create.user_id.setText(user_id.getText());
				Order_create.title.setText("Order Show");
				Order_create.setVisible(true);
				Order_create.orders(order,date);
				Order_create.Product_code.disable();
		...
		create_invoice.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				...
				create_invoice.setIcon(new ImageIcon(Dashboard.class.getResource("/img/create_invoice3.png")));
					...
					Invoice_create.title.setText("Invoice Create");
					Invoice_create.setVisible(true);
					Invoice_create.orders(order);
					Message Message= new Message();
					Message.user_id.setText(user_id.getText());
					Message.setVisible(true);
					Message.Message.setText("Successfully Created");
		...
		delete.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				...
				setVisible(false);
					...
					Message_status.class_name="Order_D";
					Message_status.order=order;
		...
		cancel.setBounds(35, 319, 150, 41);
		contentPane.add(cancel);
		create_invoice.setIcon(new ImageIcon(Order_mass.class.getResource("/img/create_invoice1.png")));
		create_invoice.setBounds(35, 215, 150, 41);
		...
		delete.setIcon(new ImageIcon(Order_mass.class.getResource("/img/delete1.png")));
		delete.setBounds(35, 267, 150, 41);

...
public class Customer_mass extends JFrame {
	...
	JLabel cancel = new JLabel("");
	    ...
	    static Customer_mass frame = new Customer_mass();
	...
	public Customer_mass() {
		...
		edit.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				...
				Customer_info.Edit.setText("Edit Customer");
		...
		delete.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				try{
					...
					String query2="delete from Customer_info where Customer_id='"+value+"'";
					
					PreparedStatement pst2=connection.prepareStatement(query2);
					
					pst2.execute();
					pst2.close();
					String query3="delete from Customer_address where Customer_id='"+value+"'";
		...
		cancel.setBounds(35, 163, 150, 41);
		contentPane.add(cancel);
		delete.setIcon(new ImageIcon(Customer_mass.class.getResource("/img/delete1.png")));

...
public class Cost extends JFrame {
	...
	public void refresh(){
		try{
			String q1="SELECT *  FROM Cost Where  Date LIKE '%" + Search.getText() + "%' or Status.Invoice_no LIKE '%" + Search.getText() + "%' or Product_code LIKE '%" + Search.getText() + "%' ";
	...
	public Cost() {
		...
		refreshes.setIcon(new ImageIcon(Cost.class.getResource("/img/refresh.png")));
		...
		JLabel title = new JLabel("Product Cost");
		...
		add_new.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				...
				Cost_info Cost_info= new Cost_info();
				Cost_info.user_id.setText(user_id.getText());
				Cost_info.setVisible(true);
				Cost_info.title.setText("New Item Cost");
		...
		table.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				Cost_mass Cost_mass= new Cost_mass();
				Cost_mass.user_id.setText(user_id.getText());
				Cost_mass.setVisible(true);
				Cost_mass.code=code;
				Cost_mass.date=date;
				Cost_mass.Message.setText("Product Code. "+code);
			}
		});
			...
			add_new.setIcon(new ImageIcon(Cost.class.getResource("/img/add_new1.png")));
			add_new.setBounds(1130, 71, 150, 41);
			...
			lblProductCode.setBounds(229, 135, 107, 14);
			contentPane.add(lblProductCode);
			
			JLabel lblDate = new JLabel("Date");
			lblDate.setFont(new Font("Futura Lt BT", Font.BOLD, 14));
			lblDate.setBounds(374, 135, 112, 14);
			contentPane.add(lblDate);
			
			JLabel lblFixedRent = new JLabel("Fixed Rent");
			lblFixedRent.setFont(new Font("Futura Lt BT", Font.BOLD, 14));
			lblFixedRent.setBounds(475, 135, 90, 14);
			contentPane.add(lblFixedRent);
			
			JLabel lblFixedUtilites = new JLabel("Fixed Utilities");
			lblFixedUtilites.setFont(new Font("Futura Lt BT", Font.BOLD, 14));
			lblFixedUtilites.setBounds(587, 135, 100, 14);
			contentPane.add(lblFixedUtilites);
			
			JLabel lblFixedEquipment = new JLabel("Fixed Equipment");
			lblFixedEquipment.setFont(new Font("Futura Lt BT", Font.BOLD, 14));
			lblFixedEquipment.setBounds(691, 135, 117, 14);
			contentPane.add(lblFixedEquipment);
			
			JLabel lblDirectLabor = new JLabel("Direct Labor");
			lblDirectLabor.setFont(new Font("Futura Lt BT", Font.BOLD, 14));
			lblDirectLabor.setBounds(818, 135, 96, 14);
			contentPane.add(lblDirectLabor);
			
			JLabel lblStatus = new JLabel("Status");
			lblStatus.setFont(new Font("Futura Lt BT", Font.BOLD, 14));
			lblStatus.setBounds(1204, 133, 96, 14);
			contentPane.add(lblStatus);
			
			JLabel lblVariableUtilities = new JLabel("Variable Utilities");
			lblVariableUtilities.setFont(new Font("Futura Lt BT", Font.BOLD, 14));
			lblVariableUtilities.setBounds(924, 135, 117, 14);
			contentPane.add(lblVariableUtilities);
			
			JLabel lblMaterials = new JLabel("Materials");
			lblMaterials.setFont(new Font("Futura Lt BT", Font.BOLD, 14));
			lblMaterials.setBounds(1066, 135, 96, 14);

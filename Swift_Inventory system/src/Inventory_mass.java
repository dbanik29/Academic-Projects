...
public class Inventory_mass extends JFrame {
	...
	JLabel cancel = new JLabel("");
	    ...
	    static Inventory_mass frame = new Inventory_mass();
		...
		edit.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				...
				if(status.equals("Inventory")){
					...
					Inventory_detail.show(code);
					Inventory_detail.Code.disable();
					Inventory_detail.edit.setText("Edit");
					...
					Return_inventory_edit.show(return_no, customer,rcode);
					Return_inventory_edit.title.setText("Return Inventory Edit");
				}
			}
			@Override
		...
		delete.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				...
				if(status.equals("Inventory")){
					...
					Message_status.class_name="Inventory";
